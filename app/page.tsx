  ...
  return <>
    <section className="hero"><div className="container hero-grid">
      ...
      <div className="hero-slider" aria-label="Damba SV Freiburg terrains">
        ...
        <div className="hero-slider-overlay"><Image src="/logo-damba.jpg" alt="Logo Damba SV Freiburg" width={72} height={72}/><div><strong>Damba SV Freiburg</strong><span>« Spass eu haben »</span></div></div>
    ...
    <section id="club" className="section"><div className="container split"><div><span className="section-kicker">{t("identity.kicker")}</span><h2>{t("identity.title")}</h2></div><div className="lead-block"><p>{t("identity.p1")}</p><p>{t("identity.p2")}</p></div></div></section>
